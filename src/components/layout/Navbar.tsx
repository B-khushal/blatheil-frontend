...
import { ShoppingBag, Menu, X, LogOut, User, Heart } from "lucide-react";
            ...
            {isAuthenticated ? (
              <div className="flex items-center gap-2">
                ...
                <div className="group relative">
                  ...
                  <div className="hidden group-hover:block absolute right-0 mt-2 w-48 bg-slate-800 border border-slate-700 rounded-lg shadow-lg py-2 z-50">
                    <p className="px-4 py-2 text-sm text-slate-300 border-b border-slate-700">
                      {user?.name}
                    </p>
                    <button
                      onClick={logout}
